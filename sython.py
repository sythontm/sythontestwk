...
@sython3.on(events.NewMessage(outgoing=True, pattern=r"\.اعادة تشغيل"))
async def update(event):
    await event.edit("• جارِ اعادة تشغيل السورس ..\n• انتضر 1-2 دقيقة  .")
    await sython3.disconnect()
    await sython3.send_message("me", "`اكتملت اعادة تشغيل السورس !`")
...
@sython4.on(events.NewMessage(outgoing=True, pattern=r"\.اعادة تشغيل"))
async def update(event):
    await event.edit("• جارِ اعادة تشغيل السورس ..\n• انتضر 1-2 دقيقة  .")
    await sython4.disconnect()
    await sython4.send_message("me", "`اكتملت اعادة تشغيل السورس !`")
...
@sython5.on(events.NewMessage(outgoing=True, pattern=r"\.اعادة تشغيل"))
async def update(event):
    await event.edit("• جارِ اعادة تشغيل السورس ..\n• انتضر 1-2 دقيقة  .")
    await sython5.disconnect()
    await sython5.send_message("me", "`اكتملت اعادة تشغيل السورس !`")
